        ...
        <tbody>
            ...
            ?>
                <tr data-type="<?php echo $assetType; ?>">
                    ...
                    <td><?php echo htmlspecialchars($website['name']); ?><?php echo $typeLabel; ?><?php if (!($website['enabled'] ?? 1)): ?><span style="font-size: 10px; padding: 2px 6px; background: #fce4ec; color: #c62828; border-radius: 4px; margin-left: 4px;">⏸ 已暂停</span><?php endif; ?></td>
                    <td>
